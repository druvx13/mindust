...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Contact Us | Mind Dust</title>
...
<body class="antialiased">
    ...
    <main class="lg:w-3/4">
        <div class="bg-slate-900/50 rounded-xl overflow-hidden border border-slate-800 p-6">
            <h2 class="text-2xl font-bold mb-6">Contact Us</h2>
            <form method="POST" class="space-y-4">
                <input type="text" name="name" placeholder="Your Name" required class="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <input type="email" name="email" placeholder="Your Email" required class="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <textarea name="message" placeholder="Your Message" required class="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg transition-all duration-300">Send Message</button>
            </form>
            <?php if (isset($_GET['success'])): ?>
                <div class="bg-indigo-900/30 p-4 mt-4 rounded-lg">
                    <p class="text-indigo-400">Message sent successfully!</p>
                </div>
            <?php endif; ?>
        </div>
    </main>
